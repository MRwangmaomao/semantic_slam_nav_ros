...
// ORBSLAM原本的Tracking线程 Tracking::Tracking(System *pSys, ORBVocabulary* pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Map *pMap,
...
// 【0】 Load camera parameters from settings file
...
// 步骤3: 跟踪失败后的处理（两两跟踪失败 or 局部地图跟踪失败）======================================================
