...
public:
	...
	System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, std::string save_folder_path, const bool bUseViewer = true, bool activate_localization_mode = false);
